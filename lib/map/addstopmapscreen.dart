...
class AddStopState extends State<AddStopPage> {
  ...
  void addStop(LatLng pos) {
    setState(() {
      _markers.add(Marker(
        markerId: MarkerId('user input stop'),
        position: pos,
        infoWindow: const InfoWindow(title: 'USER ADDED STOP'),
      ));
      getStops();
    });
  } //THIS ADDS A STOP TO THE MAP
